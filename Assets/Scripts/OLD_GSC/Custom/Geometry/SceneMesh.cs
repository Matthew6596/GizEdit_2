...
public static class MaterialExt
{
    ...
    public static Material GetStandardTransparent(Texture texture) { return new(TTResourceManager.Instance.transparentMaterial) { mainTexture=texture}; }*/
    public static Material GetStandard(Texture mainTexture, Texture normalTexture, Texture specularTexture, Color color)
    {
        Material mat = new(TTResourceManager.Instance.objectMaterial) { mainTexture = mainTexture,color=color };
    ...
    {
        Material mat = new(TTResourceManager.Instance.transparentMaterial) { mainTexture = mainTexture, color = color };
        mat.SetTexture("_BumpMap", normalTexture);
        return mat;
    }
}